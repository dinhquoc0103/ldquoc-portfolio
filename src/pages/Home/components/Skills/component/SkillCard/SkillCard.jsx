...
function SkillCard({ skill }) {
    ...
    return (
        ...
        <div className="skill-card">
            <div
                className="flex justify-center items-center w-32 h-32 rounded-full"
                style={{ background: `conic-gradient(rgb(8, 145, 170) ${percent}%, rgb(221, 221, 221) ${100 - percent}%)` }}
            >
                <div className="flex justify-center items-center w-28 h-28 bg-slate-100 rounded-full text-5xl">
